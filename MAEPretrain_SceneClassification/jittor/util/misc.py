...
# import jt
# import jt.distributed as dist
# from jt._six import inf
import jittor as jt
...
#
#     def __init__(self):
#         self._scaler = jt.cuda.amp.GradScaler()
#
...
#                 norm = jt.nn.utils.clip_grad_norm_(parameters, clip_grad)
#             else:
...
#
#
# def get_grad_norm_(parameters, norm_type: float = 2.0) -> jt.Tensor:
#     if isinstance(parameters, jt.Tensor):
...
#         else:
#             checkpoint = jt.load(args.resume, map_location='cpu')
