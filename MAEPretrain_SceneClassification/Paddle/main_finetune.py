...
def main(args):
    ...
    if args.eval:
        ...
        def torch2paddle():
            import torch
            torch_path = "/data/xiaolei.qin/Project/RVSA/Remote-Sensing-RVSA-main/MAEPretrain_SceneClassification_paddle/util/vit_rvsa_nwpu28.pth"
            paddle_path = "/data/xiaolei.qin/Project/RVSA/Remote-Sensing-RVSA-main/MAEPretrain_SceneClassification_paddle/util/vit_rvsa_nwpu28_paddle.pdparams"
            torch_state_dict = torch.load(torch_path)['model']
            # print('toch_state_dict', torch_state_dict.keys())
            # print('pth blocks.0.attn.sampling_offsets.2.weight',torch_state_dict['blocks.0.attn.sampling_offsets.2.weight'])
        ...
        final_checkpoint_dict = paddle.load("/data/xiaolei.qin/Project/RVSA/Remote-Sensing-RVSA-main/MAEPretrain_SceneClassification_paddle/util/vit_rvsa_nwpu28_paddle.pdparams")
        # print('404',final_checkpoint_dict.keys())
        # print('final_checkpoint_dict blocks.0.attn.sampling_offsets.2.weight', final_checkpoint_dict['blocks.0.attn.sampling_offsets.2.weight'])
        # 将load后的参数与模型关联起来
        # _dict = model.state_dict()
        # print('model[0]', _dict['blocks.11.mlp.fc1.bias'])
